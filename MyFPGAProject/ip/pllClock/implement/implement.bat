...
xst -ifn xst.scr
move pllClock_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\pllClock_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc pllClock_exdes.ucf pllClock_exdes

echo 'Running map'
map -timing -pr b pllClock_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm pllClock_exdes -w routed.ncd routed.v
cd ..
